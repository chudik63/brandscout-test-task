...
func (_m *QuotesRepository) AddQuote(ctx context.Context, quote *models.Quote) {
	_m.Called(ctx, quote)
}

// DeleteQuote provides a mock function with given fields: ctx, id
func (_m *QuotesRepository) DeleteQuote(ctx context.Context, id uint64) error {
...
// GetAllQuotes provides a mock function with given fields: ctx
func (_m *QuotesRepository) GetAllQuotes(ctx context.Context) ([]*models.Quote, error) {
	ret := _m.Called(ctx)
...
func (_m *QuotesRepository) GetQuote(ctx context.Context, id uint64) (*models.Quote, error) {
	ret := _m.Called(ctx, id)
...
// GetQuotesByAuthor provides a mock function with given fields: ctx, author
func (_m *QuotesRepository) GetQuotesByAuthor(ctx context.Context, author string) ([]*models.Quote, error) {
	ret := _m.Called(ctx, author)

	if len(ret) == 0 {
		panic("no return value specified for GetQuotesByAuthor")
	}
...
func (_m *QuotesRepository) GetRandomQuote(ctx context.Context) (*models.Quote, error) {
	ret := _m.Called(ctx)
